...
import { FeaturingImageContent } from './../lib/image-featuring';
...
export const name = 'abourgeons-guten/blog-txt';

registerBlockType( name, {
//export const settings = {
	title: __( 'Blog Image Txt 2018 FALL Block 01' ),
	...
	save({ attributes, className }) {
		return (
			<div className={className}>
				...
				<div className={"paragraph-inner-blocks"}>
					<InnerBlocks.Content />
				</div>
			</div>
		);
	...
	edit: edit,
	/* withNotices( ( { attributes, setAttributes, isSelected, className, noticeOperations, noticeUI } ) => {
